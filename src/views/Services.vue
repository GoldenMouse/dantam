...
<div class="services" id="services">
    <TitleHeader title="Services"></TitleHeader>
                ...
                <div class="left">
                    <div class="item">
                        ...
                        <div class="subitem">
                            ...
                            <div class="subitem--price">350</div>
                        </div>
                        <div class="subitem">
                        ...
                        <div class="subitem">
                            ...
                            <div class="subitem--price">300 /hr</div>
                        </div>
                    </div>
        ...
        <div class="container">
          <div class="terms" id="terms">
              ...
              <div class="terms--item">
                ...
                <p>A 50% deposit (client's total price) with contract is required to reserve dates (NON-REFUNDABLE and NON-TRANSFERABLE).</p>
              </div>
...
.services {
    & .service-icons  {
        background-color: var(--color-bg-gray-lighten);
        margin: 0;
        padding: 0.5rem 10%;
        display: grid;
    ...
    & .service {
        ...
        &:nth-child(1) {
            grid-area: s1;
            border-right: 1px solid var(--color-bg-gray-darken);
            border-bottom: 1px solid var(--color-bg-gray-darken);
        }
        &:nth-child(2) {
            grid-area: s2;
            // border-left: 1px solid var(--color-bg-gray-darken);
            border-right: 1px solid var(--color-bg-gray-darken);
            border-bottom: 1px solid var(--color-bg-gray-darken);
        }
        &:nth-child(3) {
